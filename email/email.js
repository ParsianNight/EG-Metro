...
const sendResetPassword = (email,token) =>{ console.log(config.key);mg.messages.create('sandbox9de3d00786e24cbebc5ce2370daa9d0e.mailgun.org', {
		from: "EG-Metro <postmaster@sandbox9de3d00786e24cbebc5ce2370daa9d0e.mailgun.org>",
		to: [email],
        ...
        <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse;max-width:600px;width:100%;background-color:#fffffe;"><tr style="vertical-align:middle;" valign="middle"><td class="content"><p style="color:#000000;font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;margin-top:0!important;">Reset password.</p><p style="color:#000000;font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;">please use the below link to reset your password. It's valid for 1 hour only. Don't share it with anyone! </p><p style="color:#000000;font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;"><a href="http://127.0.0.1:3000/forgetpassword/${token}" style="font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;text-decoration:underline;font-weight:bold;color:#0000ff;">Reset password</a></p><p style="color:#000000;font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;margin-bottom:0!important;">&mdash; &nbsp;EG-Metro</p>
        </td></tr></table>
        </td></tr></table>
        <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse;max-width:600px;width:100%;"><tr style="vertical-align:middle;" valign="middle"><td align="center" style="padding-top:30px;"><p style="mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;font-size:14px;color:#999;margin-top:0!important;margin-bottom:0!important;">Support our little project :D </p>
        </td></tr></table>
        </td></tr>
        <!--[if mso]>
        </td></tr></table>
    ...
    const sendWelcomeMail = (email, name) => {
        sgMail
          .send({
            to: email,
            from: 'Mailgun Sandbox <postmaster@sandbox9de3d00786e24cbebc5ce2370daa9d0e.mailgun.org>',
